...
void UserLED_Control_init(getUserLED_handle get_fun, setUserLED_handle set_fun)
{
...
dataEntryType snmpData[] =
{
	...
	// Control W5100S-EVB-Pico/W5500-EVB-Pico Onboard user LED(green)
...
// W5100S-EVB-Pico/W5500-EVB-Pico: LED(green) Control
